...
namespace NewFashion.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        returnUrl = "/SupplierOffer/Create";
                    }
                    if (UserManager.IsInRole(user.Id, "Seller"))
                    {
                        returnUrl = "/Sale/Create";
                    }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterUser(/*[Bind(Include = "LastName,Name,Email,PhoneNumber,Password,ConfirmPassword,UserRoles")]*/ RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Name = model.Name, Lastname = model.LastName, PhoneNumber = model.PhoneNumber };
